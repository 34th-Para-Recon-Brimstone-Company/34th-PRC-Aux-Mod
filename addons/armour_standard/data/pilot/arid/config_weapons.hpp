class 34thPRC_ArmouStandard_Pilot_IHADSS_Helmet_Arid : 34thPRC_ArmouStandard_Pilot_IHADSS_Helmet_Urban
{
	author="Over Yandere";
	displayName="[34th] IHADSS Helmet (Arid)";
	hiddenSelectionsTextures[]=
	{
		"34thPRC_ArmourStandard\data\pilot\pilot_helmet_addons.paa",
		"34thPRC_ArmourStandard\data\pilot\arid\pilot_helmet_ext.paa",
	...
	class XtdGearInfo
	{
		model="34thPRC_ArmouStandard_Pilot_IHADSS_Helmet_Urban";
		camo="arid";
	};
};
